			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">
						<span aria-hidden="true" onclick="resetEmail()">×</span>
				...
				<div class="modal-body">
					...
					<input type="email" name="recuperarEmail" id="recuperarEmail" class="form-control" autocomplete="off"/>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal" onclick="resetEmail()">Cancelar</button>
					<button type="button" class="btn btn-custom" data-toggle="modal" data-target=".password-modal" data-dismiss="modal" onclick="resetEmail()">Recuperar</button>
				</div>
			</div> 
		</div> 
	</div> 
